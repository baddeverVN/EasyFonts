 ...
 * the License.
 */
package com.example.maimi.translatecutedog.customfont;
...
import com.example.maimi.translatecutedog.R;
...
public final class EasyFonts {
    ...
    public static Typeface robotoThin(Context context){
        return FontSourceProcessor.process(R.raw.utm_neutra, context);
    }
    static class FontSourceProcessor {
